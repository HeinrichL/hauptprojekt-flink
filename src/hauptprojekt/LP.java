...
public class LP {
	...
	private static final class LPVertexInit implements MapFunction<Vertex<LongValue, NullValue>, LongValue> {
		@Override
	...
	public static void main(String[] args) throws Exception {
		...
		Graph<LongValue, LongValue, NullValue> graph = Graph.fromCsvReader(Config.HDFS_URL + file, env).fieldDelimiterEdges(" ").keyType(LongValue.class)
				.mapVertices(new LPVertexInit());

		DataSet<Vertex<LongValue, LongValue>> calc = graph.run(new LabelPropagation<>(10));
